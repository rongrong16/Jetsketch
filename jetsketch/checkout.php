...
if (!isset($_SESSION['email'])) {
  echo "<script> location.href='/jetsketch'; </script>";
  exit();
}
?>
          ...
          <div class="col-lg-4">
            <div class="order_box">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  '<li>
                    <a href="#">
                      ...
                      <span class="last">₱ ' . $row['qty'] * $row['price'] . '</span>
                    </a>
                  </li>';
              ...
              <ul class="list list_2">
                ...
                <li>
                  <a href="#">Shipping(₱ 49/product)
                    <span>₱ <?php echo $quantity*49?></span>
                  </a>
                </li>
                <li>
                  <a href="#">Total
                    <span>₱ <?php echo $sum + 49*$quantity ?></span>
                  </a>
                </li>
              </ul>
                <br><br>
